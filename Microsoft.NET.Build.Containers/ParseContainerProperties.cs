...
public class ParseContainerProperties : Microsoft.Build.Utilities.Task
{
    ...
    public override bool Execute()
    {
        ...
        try
        {
            ...
            {
                Log.LogWarning(null, KnownStrings.ErrorCodes.CONTAINER001, null, null, 0, 0, 0, 0, $"{nameof(ContainerImageName)} was not a valid container image name, it was normalized to {normalizedImageName}");
